...
### About the script for analysis run_analysis.R
...
See [run_analysis.R](https://github.com/juanhercel/Getting-and-Cleaning-Data-Project/blob/master/run_analysis.R) for more details. 
